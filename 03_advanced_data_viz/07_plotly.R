...
ggplotly(
  ggplot(cel, aes(x = seniority, y = les, color = Party,
...
# add an ids option to create object constancy - if the same member is in
# multiple congresses, move that point independently

ggplotly(
  ggplot(cel, aes(x = seniority, y = les, color = Party, frame = year,
...
# you could further modify and refine this with animation_opts(), add_markers(),
# animation_button(), or animation_slider()
