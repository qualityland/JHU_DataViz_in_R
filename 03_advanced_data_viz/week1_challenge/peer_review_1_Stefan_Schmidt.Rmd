...
ggcorrplot(r, type = "lower", title = "Correlations", ggtheme = theme_minimal())
```
...
ggplot(books_checked_out2,
       aes(y = reorder(Genre, Time1), x = Time1, xend = Time5)) +
  geom_dumbbell(colour_x = "red", colour_xend = "purple", size_x = 3, size_xend = 3) +
  labs(x = "", y = "Genre")
```
