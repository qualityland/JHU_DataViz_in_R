...
# HINT: make sure you use left_join to combine the data_values above to the
#       world map data in my_world_map
map_data_combined <-
...
# Hint: Use a filter command to put in points only for cities with a population
#       of greater than 40,000. This should leave you with 32 cities.
# Hint: Use add_column to attach the "Measurement" variable to your data, and
#       set that to the color aesthetic when you draw the points.
...
# HINT: the s_america object created in the chunk above is a simple features
#       object with many columns. Identify the correct column based on the
#       solution figure and use it to color in the choropleth.
