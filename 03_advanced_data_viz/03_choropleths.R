...
some_data_values <- data.frame(
  # the region column is here so you can join this fake data
  # with the my_state_map data by the region column
  "region" = states,
...
map_data_combined <-
  left_join(my_state_map, some_data_values, by = "region")
