...
# reformat the data to create a dichotomous categorical variable for four-year
# college grads or more, and then all respondents with 2 year college degrees
# or less
cces$educ_category <-
  recode(
    cces$educ,
...
# make sure you change the aesthetic mapping so the new categorical variable
# is mapped to "x" rather than "group"
