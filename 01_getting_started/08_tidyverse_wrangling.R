...
# make sure you have the file in your working directory, or use the complete
# file path. Use setwd() if you need to.
...
# if you need to switch back and forth between tibble and dataframe for some
# reason
...
women_republicans_educ_employ <- cces %>%
