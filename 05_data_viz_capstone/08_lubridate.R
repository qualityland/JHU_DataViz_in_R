...
# Take a character string that signifies a date, like "2020-01-01" and
# turn it into a date
...
dat$wday
# As the documentation points out, putting your dates into date-time format
# helps with math. Resolves inconsistencies associated with leap days,
# February having fewer days, and the like. Be very cautious when manipulating
# dates mathematically.
